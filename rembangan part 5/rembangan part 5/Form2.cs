...
namespace rembangan_part_5
{
    public partial class Form2 : Form
    {
        ...
        public Form2()
        {
            ...
            rectabel12 = new Rectangle(label22.Location, label22.Size);
            rectabel13 = new Rectangle(label19.Location, label19.Size);
            rectabel14 = new Rectangle(label17.Location, label17.Size);
            rectabel15 = new Rectangle(label15.Location, label15.Size);
            rectabel17 = new Rectangle(label12.Location, label12.Size);
            rectabel18 = new Rectangle(label10.Location, label10.Size);
            rectabel19 = new Rectangle(label8.Location, label8.Size);
        ...
        private void Form2_Resize(object sender, EventArgs e)
        {
            ...
            resize_Control(label22, rectabel12);
            resize_Control(label19, rectabel13);
            resize_Control(label17, rectabel14);
            resize_Control(label14, rectabel10);
            resize_Control(label21, rectabel5);
            resize_Control(label13, rectabel8);
            resize_Control(label12, rectabel17);
            resize_Control(label8, rectabel19);
